...
class Routing(Greedy):
    '''
    This class for the Routing algorithm
    ...
    def run(self):
        ...
        visualise_routes(self.case.name,[self.nodes,self.l_stations, self.m_stations, self.h_stations], l_routes + m_routes + h_routes)
