...
class Prim_ALA(Greedy):
    ...
    def run(self):
        ...
        self.calculate_tree(self.l_groups, self.l_stations)
        self.calculate_tree(self.m_groups, self.m_stations)
        self.calculate_tree(self.h_groups, self.h_stations)

        #print(f'creating visualisation')

        # visualise the stations and routes
        visualise(self.case.name,[self.nodes,self.l_stations, self.m_stations], self.connections)
        print(f'======================================')
