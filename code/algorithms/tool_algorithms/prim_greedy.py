...
class Prim_Greedy(Greedy):
    ...
    def run(self):
        ...
        l_groups = self.group_centre_point(nodes, self.case.l_energy)
        ...
        m_groups = self.group_centre_point(l_stations, self.case.m_energy)
        ...
        h_groups = self.group_centre_point(m_stations, self.case.h_energy)
